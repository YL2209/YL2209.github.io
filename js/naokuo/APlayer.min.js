			...
			var l = function() {
				...
				return i(e, [{
					...
					value: function(e) {
						...
						!this.player.template.naokuoPlayDisc.classList.contains("naokuo-play") && this.player.template.naokuoPlayDisc.classList.remove("naokuo-play");
					}
				}, {
					key: "remove",
					value: function(e) {
					...
					value: function(e) {
						if (this.player.events.trigger("listswitch", {
							...
							this.player.template.naokuoPlayDisc.classList.contains("naokuo-play") ? this.player.template.naokuoPlayDisc.classList.remove("naokuo-play") : this.player.template.naokuoPlayDisc.classList.add("naokuo-play"),
				...
				return i(e, [{
					...
					value: function() {
						...
						this.player.template.skipBackButton.addEventListener("click", function() {
							e.player.skipBack(),
							e.player.template.button.classList.contains("aplayer-pause") ? e.player.template.naokuoPlayDisc.classList.add("naokuo-play"):e.player.template.naokuoPlayDisc.classList.remove("naokuo-play");
				...
				g = function() {
					...
					return i(e, [{
						...
						value: function() {
							var e = this;
							this.setUIPlaying();
							this.template.naokuoPlayDisc && this.template.naokuoPlayDisc.classList.add("naokuo-play");					
						...
						value: function() {
							this.setUIPaused(), 
							this.audio.pause(), 
							this.template.naokuoPlayDisc && this.template.naokuoPlayDisc.classList.remove("naokuo-play");
						}
					}, {
