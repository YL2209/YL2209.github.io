				...
				g = function() {
					...
					return i(e, [{
						...
						value: function() {
							var e = this;
							this.setUIPlaying();
							!this.template.naokuoPlayDisc.classList.contains("naokuo-play") && this.template.naokuoPlayDisc.classList.add("naokuo-play");					
						...
						value: function() {
							this.setUIPaused(), 
							this.audio.pause(), 
							this.template.naokuoPlayDisc.classList.contains("naokuo-play") && this.template.naokuoPlayDisc.classList.remove("naokuo-play");
						}
					}, {
